...
static bool get_qos(const Config &config_ros, const std::string &module_name,
                    const std::string &param_name, std::string &profile_name,
                    rclcpp::QoS &qos) {
...
rclcpp::QoS get_qos_settings(const Config                     &config_ros,
  ...
  spdlog::trace(
      ...
      param_name, profile_name, qos.depth(),
